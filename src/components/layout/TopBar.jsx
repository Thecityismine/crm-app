  ...
  return (
    <header className="h-14 bg-white border-b border-gray-200 flex items-center px-4 gap-3">
      ...
      <button
        ...
        className="flex items-center gap-2 px-3 py-1.5 bg-gray-100 rounded-lg text-sm text-gray-500 hover:bg-gray-200 flex-1 max-w-sm"
      >
        <Search size={14} />
        Search or ask AI...
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <button onClick={logout} className="p-1.5 rounded-lg hover:bg-gray-100 text-gray-500">
          <LogOut size={16} />
        </button>
      </div>
    </header>

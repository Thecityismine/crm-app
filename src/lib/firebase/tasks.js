...
const colUrl = () =>
  `https://firestore.googleapis.com/v1/projects/${projectId()}/databases/(default)/documents/${COLLECTIONS.TASKS}`
...
export const getTasks = async () => {
  ...
  const response = await fetch(url, {
    ...
    body: JSON.stringify({
      structuredQuery: {
        from: [{ collectionId: COLLECTIONS.TASKS }],
...
export const createTask = (data) => restWrite('create', null, data)
export const updateTask = (id, data) => restWrite('update', id, data)
export const deleteTask = (id) => restWrite('delete', id, null)
